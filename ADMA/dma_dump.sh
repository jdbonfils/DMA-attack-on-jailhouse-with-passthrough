...
echo -n -e $1  > /sys/devices/platform/soc\@0/soc\@0\:bus\@30800000/30b50000.mmc/adma_dump && dd if=/dev/random of=/mnt/out bs=1K count=$2 && cat /sys/devices/platform/soc\@0/soc\@0\:bus\@30800000/30b50000.mmc/adma_reset && umount /mnt/ && mount /dev/mmcblk2p2 /mnt/ && hexdump -C /mnt/out
